...
const DEFAULT_MIRROR =
  'https://raw.githubusercontent.com/IBM/python-versions-pz/main';
...
describe('getManifestUrl', () => {
  it('defaults to the IBM/python-versions-pz manifest', () => {
...
describe('getManifestFromRepo mirror resolution', () => {
  it('resolves the default mirror to IBM/python-versions-pz@main with token', async () => {
    setInputs({token: 'TKN'});
